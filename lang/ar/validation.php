...
return  [
    ...
    "attributes" => [
        ...
        'parent_id'         => 'الشركة',
        "customer_id"       => "طالب الخدمة",
        "company_id"        => "الشركة",
        "driver_id"         => "السائق",
        "price"             => "السعر",
        "from_city_id"      => "المدينة - نقطة الانطلاق",
        "from_region_id"    => "المنطقة - نقطة الانطلاق",
        "to_city_id"        => "المدينة - الوجهة",
        "to_region_id"      => "المنطقة - الوجهة",
        "go_time"           => "وقت الانطلاق",
        "date"              => "التاريخ",
        'category_id'                        =>  'نوع الرحلة',
