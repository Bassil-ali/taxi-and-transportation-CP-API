...
class CustomerController extends Controller
{
    public function index(): View
    {
        ...
        $datatables = (new DatatableServices())->header(
            [
                'route' => route('dashboard.admin.app.trips.customers.data'),
                'header'  => [
        ...
        return view('dashboard.admin.apps.trips.customers.index', compact('datatables'));
    ...
    public function data(): object
    {
        ...
        return dataTables()->of($trips)
            ...
            ->addColumn('actions', fn(Trip $trip) => adminAction(['edit', 'delete'], $permissions, $trip, 'app.trips.customers'))
    ...
    public function store(TripRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('dashboard.admin.app.trips.customers.index');

    }//end of store

    public function edit(Trip $customer): View
    {
        if(!permissionAdmin('update-trips')) {
            return abort(403);
        }

        return view('dashboard.admin.apps.trips.edit', compact('customer'));

    }//end of edit

    public function update(TripRequest $request, Trip $customer): RedirectResponse
    {
    ...
    public function destroy(Trip $customer): Application | Response | ResponseFactory
    {
        $customer->delete();
