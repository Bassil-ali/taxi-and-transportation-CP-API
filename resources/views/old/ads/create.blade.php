...
@section('page-title', __('cms.ads') . ' | ' . __('cms.create'))
        ...
        <div class="container-fluid">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title fw-bolder"><span> {{ __('cms.new_ad') }} </span>
                    </h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                ...
                <form class="form-horizontal " id="create-form" autocomplete="off">
                    ...
                    <div class="card-body">
                            ...
                            <div class="d-flex flex-row">
                                <div class="col-sm-10 col-md-4">
                                    <select name="duration" id="duration" data-control="select2"
                                        ...
                                        <option value="1">{{ __('cms.immediately') }} </option>
                                        <option value="2"> {{ __('cms.weekly') }} </option>
                                        <option value="3">{{ __('cms.monthly') }} </option>
                                    </select>
                                ...
                                <div class="col-sm-10 col-md-8">
                                    <select name="category_id" id="category_id" data-control="select2"
                                        ...
                                        @foreach ($categories as $categorey)
                                            <option value="{{ $categorey->id }}">{{ $categorey->name_ar }} </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group " style="width:50%">
                                ...
                                <div class="col-sm-10 col-md-8">
                                    <select name="gender" id="gender" data-control="select2"
                                        ...
                                        <option value="1">{{ __('cms.male') }} </option>
                                        <option value="2">{{ __('cms.female') }} </option>
                                        <option value="3">{{ __('cms.both') }} </option>
                                    </select>
                            ...
                            <div class="form-group " style="width:50%">
                                ...
                                <div class="col-sm-10 col-md-8">
                                    <select name="communication" id="communication" data-control="select2"
                                        ...
                                        class="form-select  form-select-solid">
                                        <option value="1">{{ __('cms.mobile') }} </option>
                                        <option value="2">{{ __('cms.email') }} </option>
                                    </select>
                        ...
                        <div class="form-group d-flex flex-row mb-10">
                            ...
                            <div>
                                <label for="time"
                                    class="   col-md-12  col-sm-2 col-form-label ">{{ __('cms.return_time') }}</label>
                            ...
                            <div class="form-group " style="width:50%">
                                ...
                                <div class="col-sm-10 col-md-8">
                                    <select name="service_provider" id="service_provider" data-control="select2"
                                        data-placeholder="{{ __('cms.select_service_provider') }}"
                                        class="form-select  form-select-solid">
                                        <option value="1">{{ __('cms.mobile') }} </option>
                                        <option value="2">{{ __('cms.email') }} </option>
                                    </select>
                        ...
                        <div class="d-flex flex-row mb-10">
                            <div class="form-group " style="width:50%">
                                <!-- row -->
                                <label for="price"
                                    class="   clo-lg-2 col-md-8  col-form-label">{{ __('cms.price') }}</label>
                                <div class="col-sm-10 col-md-8">
                            ...
                            <div class="form-group " style="width:50%">
                                ...
                                <label for="people_number"
                                    class=" required  clo-lg-2 col-md-8 col-form-label">{{ __('cms.people_number') }}</label>
                                <div class="col-sm-10 col-md-8">
                        ...
                        <div class="d-flex flex-row mb-10">
                            ...
                            <div class="form-group " style="width:50%">
                                ...
                                <div class="col-sm-10 col-md-8">
                                    <input type="number" class="form-control" id="estimated_time" placeholder="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group  mb-10">
                            <!-- row -->
                            <label for="notes"
                                class="   clo-lg-2 col-md-4  col-form-label">{{ __('cms.notes') }}</label>
...
@section('scripts')
    ...
    <script>
        function store() {
            ...
            axios.post('/cms/ads', data).then(function(response) {
                    // handle success
