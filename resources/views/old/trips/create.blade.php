...
@section('page-title', __('cms.trips') . ' | ' . __('cms.create'))
        ...
        <div class="container-fluid">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title fw-bolder"><span> {{ __('cms.new_trip') }} </span>
                    </h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-group" style="width:25%; ">
                                ...
                                <div class="d-flex flex-column mb-5 fv-row">
                                    ...
                                    <select name="service_provider" id="service_provider" data-control="select2"
                                        ...
                                        <option value=""> </option>
                                        <option value="1">{{ __('cms.company') }} </option>
                                    ...
                                    <select name="from_region_id" id="from_region_id" data-control="select2"
                                      ...
                                      >
                                        ...
                                        @foreach ($regions as $region)
                                            <option value="{{ $region->id }}">{{ $region->name_lang }} </option>
                                        @endforeach
                                        {{-- <option   selected>2</option> --}}
                                    </select>
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="position-relative d-flex align-items-center">
                                ...
                                <!--end::Svg Icon-->
                                <input class="form-control form-control-solid ps-12" name="date" style="width:31%"
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-10">
                                <input type="time" class="form-control "  id="go_time" placeholder=""
                                    style="width:37%">
                            </div>
                        </div>
...
@section('scripts')
    ...
    <script>
        function store() {
            ...
            axios.post('/cms/trips', data).then(function(response) {
                    // handle success
