										...
										<table class="table align-middle gs-0 gy-4" id="">
											...
											<tbody class="fw-bold text-gray-600">
												...
												<tr>
													...
													<!--begin::Name=-->
                                                    <td>
														<a href="#" class="text-gray-800 text-hover-primary mb-1">{{$city->id}}</a>
													</td>

													<td>
														<a href="#" class="text-gray-800 text-hover-primary mb-1">{{$city->name_lang}}</a>
													</td>
													<!--end::Name=-->
													<!--begin::Email=-->
													<td>
														<a href="#" class="text-gray-600 text-hover-primary mb-1">{{$city->name_lang}}</a>
													</td>
													<!--end::Email=-->
                                                    ...
                                                    <td >
                                                        @if ($city->status)
                                                        <span class="badge badge-light-success">{{$city->name_lang}}</span>
                                                        @else
                                                        <span class="badge badge-light-danger">{{$city->name_lang}}</span>
                                                        @endif
													...
													<!--begin::Action=-->
													<td class="text-end">
														<a href="#" class="btn btn-sm btn-light btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">{{__('cms.actions')}}
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															...
															<div class="menu-item px-3">
																<a href="{{route('cities.edit' , $city->id)}}" class="menu-link px-3">{{__('cms.edit')}}</a>
															</div>
															<!--end::Menu item-->
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="#" onclick="performDestroy('{{$city->id}}', this)" class="menu-link px-3" data-kt-customer-table-filter="delete_row">{{__('cms.delete')}}</a>
															</div>
															<!--end::Menu item-->
														</div>
														<!--end::Menu-->
