...
@section('page-title' , __('cms.transport_types') .' | '. __('cms.create'))
    ...
    <div class="container-fluid">
            ...
            <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title fw-bolder" > {{__('cms.add_type')}} </span></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
...
<script>
    ...
    function store(){
        ...
        axios.post('/cms/transport-types',data).then(function (response) {
                // handle success
