...
@section('page-title', __('cms.transport_types'))
@section('main-title', __('cms.transport_types'))
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                @can('TransportTypes-Create')
                                    <a class="btn btn-primary"
                                        href="{{ route('transport-types.create') }}">{{ __('cms.add_type') }}</a>
                                @endcan
                                <!--end::Add customer-->
                            </div>
                            <!--end::Toolbar-->
                            ...
                            <tbody class="fw-bold text-gray-600">
                                @foreach ($transport_types as $transport)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary mb-1">{{ $transport->id }}</a>
                                        </td>

                                        <td>
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary mb-1">{{ $transport->name_ar }}</a>
                                        </td>
                                        <!--end::Name=-->
                                        <!--begin::Email=-->
                                        <td>
                                            <a href="#"
                                                class="text-gray-600 text-hover-primary mb-1">{{ $transport->name_en }}</a>
                                        </td>
                                        <!--end::Email=-->
                                        ...
                                        <td>
                                            @if ($transport->status)
                                                <span
                                                    class="badge badge-light-success">{{ $transport->status_name }}</span>
                                            @else
                                                <span class="badge badge-light-danger">{{ $transport->status_name }}</span>
                                            @endif
                                        </td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                data-kt-menu="true">
                                                <!--begin::Menu item-->
                                                @can('TransportTypes-Update')
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('transport-types.edit', $transport->id) }}"
                                                            class="menu-link px-3">{{ __('cms.edit') }}</a>
                                                    </div>
                                                @endcan
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                @can('TransportTypes-Delete')
                                                    <div class="menu-item px-3">
                                                        <a href="#"
                                                            onclick="performDestroy('{{ $transport->id }}', this)"
...
@section('scripts')
    ...
    <script>
        function performDestroy(id, reference) {
            confirmDestroy('/cms/transport-types', id, reference);
        }
    </script>
