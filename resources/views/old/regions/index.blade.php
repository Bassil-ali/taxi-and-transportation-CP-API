...
@section('page-title', __('cms.regions'))
                            ...
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                ...
                                @can('Regions-Create')
                                    <a class="btn btn-primary"
                                        href="{{ route('regions.create') }}">{{ __('cms.add_regions') }}</a>
                                @endcan
                                <!--end::Add customer-->
                            </div>
                            <!--end::Toolbar-->
                        ...
                        <table class="table align-middle gs-0 gy-4" id="">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">{{ __('cms.city') }}</th>
                            ...
                            <tbody class="fw-bold text-gray-600">
                                @foreach ($regions as $region)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary mb-1">{{ $region->id }}</a>
                                        </td>

                                        <td>
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary mb-1">{{ $region->name_ar }}</a>
                                        </td>
                                        <!--end::Name=-->
                                        <!--begin::Email=-->
                                        <td>
                                            <a href="#"
                                                class="text-gray-600 text-hover-primary mb-1">{{ $region->name_en }}</a>
                                        </td>
                                        <td>
                                            <a href="#"
                                                class="text-gray-600 text-hover-primary mb-1">{{ $region->city?->name_lang }}</a>
                                        </td>
                                        <!--end::Email=-->
                                        ...
                                        <td>
                                            @if ($region->status)
                                                <span class="badge badge-light-success">{{ $region->status_name }}</span>
                                            @else
                                                <span class="badge badge-light-danger">{{ $region->status_name }}</span>
                                            @endif
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                ...
                                                @can('Regions-Delete')
                                                    <div class="menu-item px-3">
                                                        <a href="#" onclick="performDestroy('{{ $region->id }}', this)"
...
@section('scripts')
    ...
    <script>
        function performDestroy(id, reference) {
            confirmDestroy('/cms/regions', id, reference);
        }
    </script>
