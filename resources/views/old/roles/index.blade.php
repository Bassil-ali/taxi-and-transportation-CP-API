...
@section('page-title', __('cms.roles'))
                            ...
                            {{-- <div class="d-flex align-items-center position-relative my-1">
												...
												<span class="svg-icon svg-icon-1 position-absolute ms-6">
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														<rect oparole="0.5" x="17.0365" y="15.1223" width="8.15546" height="2" rx="1" transform="rotate(45 17.0365 15.1223)" fill="black" />
                            ...
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                ...
                                @can('Roles-Create')
                                    <a class="btn btn-primary"
                                        href="{{ route('roles.create') }}">{{ __('cms.create_new_role') }}</a>
                                @endcan
                                <!--end::Add customer-->
                            </div>
                            <!--end::Toolbar-->
                        ...
                        <table class="table align-middle gs-0 gy-4" id="">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px"> {{ __('cms.permissions') }}</th>
                            ...
                            <tbody class="fw-bold text-gray-600">
                                @foreach ($roles as $role)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary mb-1">{{ $role->id }}</a>
                                        </td>
                                        ...
                                        <td>
                                            <a href="{{ route('roles.show', $role->id) }}"
                                                class="btn btn-sm btn-primary me-3">{{ __('cms.permissions') . ' ( ' . $role->permissions_count . ' ) ' }}</a>
                                        </td>
