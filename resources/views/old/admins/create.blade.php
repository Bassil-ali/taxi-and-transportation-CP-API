...
@section('page-title' , __('cms.admins') .' | '. __('cms.create'))
    ...
    <div class="container-fluid">
            ...
            <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title fw-bolder" ><span> {{__('cms.add_admin')}} </span> </h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                ...
                <form class="form-horizontal " id="create-form">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group ">  <!-- row -->
                        ...
                        <div class="col-sm-10">
                          <input type="phone" class="form-control" id="mobile"   placeholder="" >
                        </div>
                    </div>
                    <div class="form-group ">  <!-- row -->
                    ...
                    <div class="form-group ">  <!-- row -->
                        <label for="password_confirmation" class="col-sm-2 col-form-label">{{__('cms.password_confirmation')}}</label>
                        <div class="col-sm-10">
                          <input type="password_confirmation" class="form-control" id="password_confirmation"   placeholder="" >
                        </div>
                    </div>
...
<script>
    ...
    function store(){
        ...
        axios.post('/cms/admins',data).then(function (response) {
                // handle success
