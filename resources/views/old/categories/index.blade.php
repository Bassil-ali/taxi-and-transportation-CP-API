...
@section('page-title', __('cms.categories'))
                            ...
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                @can('Categories-Create')
                                    <a class="btn btn-primary"
                                        href="{{ route('categories.create') }}">{{ __('cms.add_category') }}</a>
                                @endcan
                                <!--end::Add customer-->
                            </div>
                            <!--end::Toolbar-->
                            ...
                            <tbody class="fw-bold text-gray-600">
                                @foreach ($categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary mb-1">{{ $category->id }}</a>
                                        </td>
                                        ...
                                        <td>
                                            <a href="#"
                                                class="text-gray-600 text-hover-primary mb-1">{{ $category->name_en }}</a>
                                        </td>
                                        <!--end::Email=-->
                                        ...
                                        <td>
                                            @if ($category->status)
                                                <span class="badge badge-light-success">{{ $category->status_name }}</span>
                                            @else
                                                <span class="badge badge-light-danger">{{ $category->status_name }}</span>
                                            @endif
                                        </td>
