...
@section('page-title' , __('cms.categories') .' | '. __('cms.create'))
    ...
    <div class="container-fluid">
            ...
            <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title fw-bolder" > {{__('cms.add_category')}} </span></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
...
<script>
    ...
    function store(){
        ...
        axios.post('/cms/categories',data).then(function (response) {
                // handle success
