<x-dashboard.admin.layouts.app>
    ...
    <x-slot name="title">{{ trans('admin.menu.languages') }}</x-slot>

    <div class="card shadow-sm">

        <div class="card-header">
            <h3 class="card-title">{{ trans('admin.menu.languages') }}</h3>
        </div>
            ...
            <div class="card-toolbar">
                @if(permissionAdmin('create-languages'))
                    <div class="m-2">
                        ...
                        <x-dashboard.admin.btn.add route="dashboard.admin.management.languages.create"/>
                    </div>
                @endif

                @if(permissionAdmin('delete-languages'))
                    <x-dashboard.admin.data-table.btn.bulk-delete route="dashboard.admin.management.languages.bulk_delete"/>
                @endif
            </div>
