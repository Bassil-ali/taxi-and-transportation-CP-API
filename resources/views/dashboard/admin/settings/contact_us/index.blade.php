<x-dashboard.admin.layouts.app>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-header">
            <h3 class="card-title">{{ trans('admin.menu.settings') . ' - ' . trans('admin.settings.contact') }}</h3>
        </div>
        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                @if(permissionAdmin('delete-admins'))
                    <x-dashboard.admin.data-table.btn.bulk-delete route="dashboard.admin.setting.contact.bulk_delete"/>
                @endif
            </div>
