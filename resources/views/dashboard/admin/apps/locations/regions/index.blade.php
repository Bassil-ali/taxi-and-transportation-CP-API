<x-dashboard.admin.layouts.app>
    ...
    <x-slot name="title">{{ trans('admin.menu.regions') }}</x-slot>

    <div class="card shadow-sm">

        <div class="card-header">
            <h3 class="card-title">{{ trans('admin.menu.regions') }}</h3>
        </div>
            ...
            <div class="card-toolbar">
                @if(permissionAdmin('create-regions'))
                    <div class="m-2">
                        ...
                        <x-dashboard.admin.btn.add route="dashboard.admin.app.locations.regions.create"/>
                    </div>
                @endif

                @if(permissionAdmin('delete-regions'))
                    <x-dashboard.admin.data-table.btn.bulk-delete route="dashboard.admin.app.locations.regions.bulk_delete"/>
                @endif
            </div>
