<x-dashboard.admin.layouts.app>
    ...
    <x-slot name="title">
        {{ trans('admin.global.create') . ' - ' . trans('admin.menu.city') }}
    </x-slot>

    <div class="card card-flush shadow-sm">

        <div class="card-header">
            <h3 class="card-title">{{ trans('admin.global.create_new', ['name' => trans('admin.menu.city')]) }}</h3>
        ...
        <div class="card-body py-5">
            ...
            <form method="post" action="{{ route('dashboard.admin.app.locations.cities.store') }}">
