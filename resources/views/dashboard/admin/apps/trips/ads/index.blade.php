<x-dashboard.admin.layouts.app>
    ...
    <x-slot name="title">{{ trans('admin.menu.app') . ' - ' . trans('admin.menu.trips') . ' - ' . trans('admin.menu.ads') }}</x-slot>

    <div class="card shadow-sm">

        <div class="card-header">
            <h3 class="card-title">{{ trans('admin.menu.app') . ' - ' . trans('admin.menu.trips') . ' - ' . trans('admin.menu.ads') }}</h3>
        </div>
        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                @if(permissionAdmin('delete-trips'))
                    <x-dashboard.admin.data-table.btn.bulk-delete route="dashboard.admin.app.trips.ads.bulk_delete"/>
                @endif
            </div>
