<x-dashboard.admin.layouts.app>
    ...
    <x-slot name="title">{{ trans('admin.menu.app') . ' - ' . trans('admin.menu.transport_types') }}</x-slot>

    <div class="card shadow-sm">

        <div class="card-header">
            <h3 class="card-title">{{ trans('admin.menu.transport_types') }}</h3>
        </div>
            ...
            <div class="card-toolbar">
                @if(permissionAdmin('create-transport_types'))
                    <div class="m-2">
                        ...
                        <x-dashboard.admin.btn.add route="dashboard.admin.app.transport_types.create"/>
                    </div>
                @endif

                @if(permissionAdmin('delete-transport_types'))
                    <x-dashboard.admin.data-table.btn.bulk-delete route="dashboard.admin.app.transport_types.bulk_delete"/>
                @endif
            </div>
