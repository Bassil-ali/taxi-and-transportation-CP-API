<x-dashboard.admin.layouts.app>
    ...
    <x-slot name="title">{{ trans('admin.menu.app') . ' - ' . trans('admin.menu.users') . ' - ' . trans('admin.global.customers') }}</x-slot>

    <div class="card shadow-sm">

        <div class="card-header">
            <h3 class="card-title">{{ trans('admin.menu.app') . ' - ' . trans('admin.menu.users') . ' - ' . trans('admin.global.customers') }}</h3>
        </div>
        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                @if(permissionAdmin('delete-users'))
                    <x-dashboard.admin.data-table.btn.bulk-delete route="dashboard.admin.app.users.customers.bulk_delete"/>
                @endif
            </div>
